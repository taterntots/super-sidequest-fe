      ...
      {users.length === 0 ? (
        <div className='text-center text-white'>
          <p className='text-lg leading-6'>
            There are no users with completed quests for this leaderboard
          </p>
        </div>
      ) : (
        <div className='w-full h-full px-2 bg-profiletwo rounded-lg text-white'>
          ...
          <div className='rounded-lg bg-gray-700 my-2'>
            <div className='flex w-full text-center px-2 py-1 font-bold'>
              <p className='w-2/12 sm:w-1/12'>Rank</p>
              <p className='w-8/12 sm:w-10/12'>Player</p>
              <p className='w-2/12 sm:w-1/12'>Level</p>
            </div>
