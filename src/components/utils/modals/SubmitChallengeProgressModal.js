            ...
            <div className='inline-block w-full mx-6 align-middle rounded-lg text-left overflow-hidden shadow-xl transform transition-all max-w-lg'>
              <form className='p-10 bg-taterpurple rounded-lg text-white' onSubmit={handleSubmit(submitChallengeProgress)}>
                ...
                <div className='sm:flex sm:justify-evenly'>
                  ...
                  <button
                    type='submit'
                    className={loading ? 'opacity-80 pointer-events-none flex w-full sm:w-auto justify-center items-center rounded-lg text-lg sm:px-12 py-3 mb-4 sm:mb-0 text-center font-medium bg-purplebutton hover:bg-white hover:text-purplebutton focus:ring transition duration-150 ease-in-out' :
                      'flex w-full sm:w-auto justify-center items-center rounded-lg text-lg sm:px-12 py-3 mb-4 sm:mb-0 text-center font-medium bg-purplebutton hover:bg-white hover:text-purplebutton focus:ring transition duration-150 ease-in-out'
                    }
                  >
                    {loading ? (
