...
const UnbanUserModal = ({ open, setOpen, submitUserUnban, loading }) => {
            ...
            <div className='inline-block w-full mx-6 mt-14 align-middle rounded-lg text-left overflow-hidden shadow-xl transform transition-all max-w-lg'>
              <div className='p-10 bg-taterpurple rounded-lg text-white'>
                ...
                <p className='text-center mb-4'>
                  Are you sure you want to unban this user? This will bring back all associated quests created by this
                  user from the site, including for others who have accepted/completed their quests.
                </p>
