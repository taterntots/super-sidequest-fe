            ...
            <div className='inline-block w-full mx-6 align-middle rounded-lg text-left overflow-hidden shadow-xl transform transition-all max-w-lg'>
              <div className='p-10 bg-taterpurple rounded-lg text-white'>
                ...
                <div className='sm:flex sm:justify-evenly'>
                  ...
                  <button
                    type='button'
                    className='flex w-full sm:w-auto justify-center items-center rounded-lg text-lg sm:px-12 py-3 sm:mb-0 text-center font-medium bg-addgreen hover:bg-white hover:text-addgreen focus:ring transition duration-150 ease-in-out'
